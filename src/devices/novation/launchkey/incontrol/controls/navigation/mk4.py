"""
devices > novation > launchkey > incontrol > controls > navigation > mk4
...
class MiniMk4DirectionUp(DirectionUp):
...
class MiniMk4DirectionDown(DirectionDown):
    def __init__(self) -> None:
        super().__init__(
...
class Mk4DirectionUp(DirectionUp):
    def __init__(self) -> None:
        super().__init__(
...
class Mk4DirectionDown(DirectionDown):
    def __init__(self) -> None:
        super().__init__(
...
class Mk4DirectionUpSilenced(NullControl):
    """Up/down buttons on LkMk4 seem to provide extra events, which we ignore
    """
    def __init__(self) -> None:
        super().__init__(
...
class Mk4DirectionDownSilenced(NullControl):
    """Up/down buttons on LkMk4 seem to provide extra events, which we ignore
    """
    def __init__(self) -> None:
        super().__init__(
